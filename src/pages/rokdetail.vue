  ...
  >
    <q-page>
      <q-header class="bg-transparent text-black">
        <q-toolbar>
          ...
          <div v-for="nomor in nomor.data" v-bind:key="nomor.id">
            <div v-if="nomor.key === 'site.titlleskirtcustom'">
      ...
      <q-page-container>
        ...
        >
          <div v-for="nomor in nomor.data" v-bind:key="nomor.id">
            <div v-if="nomor.key === 'site.rokkustom'">
              <img
                :src="
          ...
          <q-card-section>
            <div v-for="nomor in nomor.data" v-bind:key="nomor.id">
              ...
              <div v-if="nomor.key === 'site.contentskirtcustom'">
                <q-input
                  ...
                  <q-btn
                    ...
                    @click="
                      redirect(
                        'https://wa.me/62' +
                          nomor.value +
                          '?text=PEMESANAN%20ROK%20KUSTOM%20%0D%0A%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%20%0D%0ANAMA%20PEMESAN%20%20%3A%20%20' +
                          namapemesan +
...
export default {
  data() {
    return {
      ...
      optionmodel: [
        "Rok sepan panjang 7/8",
        "Rok sepan belahan belakang",
        "Rok rempel"
      ],
