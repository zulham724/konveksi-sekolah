    ...
    <q-page>
      ...
      <q-page-container>
        <q-card
          ...
          style="height: 100%; margin: 10px; margin-buttom:20px; margin-left:10px; margin-right:10px; border-radius:20px; "
          shadow-box
        >
          <div v-for="nomor in nomor.data" v-bind:key="nomor.id">
            <div v-if="nomor.key === 'site.bajukustomgirl'">
              <q-img
                :src="
                  ...
                  <q-btn
                    ...
                    @click="
                      redirect(
                        'https://wa.me/62' +
                          nomor.value +
                          '?text=PEMESANAN%20BAJU%20PEREMPUAN%20KUSTOM%20%0D%0A%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%3D%20%0D%0ANAMA%20PEMESAN%20%20%3A%20%20' +
                          namapemesan +
